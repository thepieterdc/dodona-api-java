...
public final class SeriesAccessDeniedException extends ResourceAccessDeniedException {
	 ...
	 */
	public SeriesAccessDeniedException(final String url, final @Nullable String reason) {
		super(reason != null ? reason : String.format("You may not access the series at url %s.", url));
		this.url = url;
	}
