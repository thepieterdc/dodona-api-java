 ...
 */
package io.github.thepieterdc.dodona.impl.http;
...
import io.github.thepieterdc.dodona.impl.exeptions.HttpException;
...
public final class HttpWrapper {
	...
	/**
	 * Performs a generic HTTP request to the given url.
	 *
	 * @param endpoint  the endpoint to call
	 * @param apiToken  the api token
	 * @param ua        the user agent
